...
function employeeCreation(request) {
  var options;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return Object(__WEBPACK_IMPORTED_MODULE_3_redux_saga_effects__["a" /* call */])(__WEBPACK_IMPORTED_MODULE_2__api__["a" /* createEmpDetails */], request);
...
function getEmpDetails() {
  return __WEBPACK_IMPORTED_MODULE_0_superagent___default.a.get('/graphql').query({ query: '{login {name password} }' }).set('Accept', 'application/json').then(function (resp) {
...
function createEmpDetails() {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_superagent___default.a.post('/graphql').set({ query: query,
    variables: { empName: empName, empAge: empAge, empSalary: empSalary }
...
//# sourceMappingURL=0.2c061ed4a01930a6a2f7.hot-update.js.map