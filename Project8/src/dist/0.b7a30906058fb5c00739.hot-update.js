...
function createEmpDetails() {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_superagent___default.a.post('/graphql').query({ query: query }).set('Accept', 'application/json').then(function (resp) {
    return JSON.parse(resp.text).data.login;
  });
}
;
...
//# sourceMappingURL=0.b7a30906058fb5c00739.hot-update.js.map