...
import AntiForgeryToken from '../containers/AntiForgeryToken';
...
const LoginUI = ({
  ...
  serverErrorMessage && serverErrorMessage !== 'Unauthorized' ?
    <IdentityServerError />
    :
      ...
      <div className="login-form">
        <form
          ...
          onSubmit={(e) => {
            ...
            const message = [
              !Number.isInteger(user.dataSourceId) && !isInt(`${user.dataSourceId}`) ? 'Please provide a valid data source' : null,
